          ...
          <div className="uk-grid uk-child-width-1-3">
            ...
            <div>
              <input
                ...
                className="uk-input"
                value={this.props.data.microWeatheredTotalRib1 || 0}
                onChange={this.props.updateMDS}
              />
            </div>
          </div>
          ...
          <div className="uk-grid uk-child-width-1-3">
            ...
            <div>
              <input
                ...
                value={this.props.data.microFreshTotalRib2 || 0}
                className="uk-input"
                onChange={this.props.updateMDS}
              />
            </div>
            <div>
              <input
                ...
                className="uk-input"
                value={this.props.data.microWeatheredTotalRib2 || 0}
                onChange={this.props.updateMDS}
              />
            </div>
          </div>
          ...
          <div className="uk-grid uk-child-width-1-3">
            ...
            <div>
              <input
                ...
                value={this.props.data.microFreshTotalRib3 || 0}
                className="uk-input"
                onChange={this.props.updateMDS}
              />
            </div>
            <div>
              <input
                ...
                className="uk-input"
                value={this.props.data.microWeatheredTotalRib3 || 0}
                onChange={this.props.updateMDS}
              />
            </div>
          </div>
          ...
          <div className="uk-grid uk-child-width-1-3">
            ...
            <div>
              <input
                ...
                value={this.props.data.microFreshTotalRib4 || 0}
                className="uk-input"
                onChange={this.props.updateMDS}
              />
            </div>
            <div>
              <input
                ...
                className="uk-input"
                value={this.props.data.microWeatheredTotalRib4 || 0}
                onChange={this.props.updateMDS}
              />
            </div>
          </div>
