...
export function LandingPage(props) {
  ...
  return (
    <div className="uk-width-1-1">
      ...
      <div className="uk-flex uk-flex-middle uk-flex-center uk-flex-column uk-background-blend-overlay uk-background-darken uk-background-cover" style={ background_image }>
        <div className="uk-flex uk-flex-row uk-padding .uk-animation-slide-bottom">
          ...
          <button className="uk-button uk-button-default uk-button-large" style={ textButtonStyles }>
        ...
        <div className="uk-heading-hero" id="header-text">
