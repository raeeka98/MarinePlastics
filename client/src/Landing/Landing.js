/**
 * Landing.js
 * Displays the landing page, which is the first page a user arrives at when
 * navigating to the website. Has the option to sign up/log in or continue as
 * guest. If the user is already logged in, the user only has the option to
 * continue to the main website. The authentication object is passed through
...
export function LandingPage(props) {
  ...
  return (
    <div className="uk-width-1-1 uk-flex uk-flex-row">
      <div
        className="uk-width-1-3 uk-background uk-background-cover"
        ...
        <div className="uk-flex uk-flex-middle uk-flex-column">
          ...
          <div className="uk-flex uk-flex-column intro-text">
            ...
            <p>
              ...
              monitoring, we have developed a standardized protocols to gather
              data from beach cleanups and ways to analyze the differences in
              debris between regions and over time.
            </p>
          </div>
          ...
          <div className="uk-flex uk-flex-column uk-padding">
            ...
            <Link
              className=
              "uk-button uk-button-default uk-button-large guest-button"
              to="/home"
            >
              {
